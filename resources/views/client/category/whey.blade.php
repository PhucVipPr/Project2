    ...
    <section class="category">
        <div class="container">
            <div class="category-top row">
                <p><a href="{{url('/client/home')}}">Trang chủ</a></p> <span>&#10230; </span> <p><a href="{{url('/client/category/whey')}}">Whey protein</a></p>
            </div>
        </div>
        <div class="container">
            <div class="row">
               @include('client.categoryLeft')
                <div class="category-right">
                    <div class="category-right-top-item">
                        <p><a href="{{url('/client/category/whey')}}">Whey protein</a></p>
                    </div>
                    <div class="category-right-top-item">
                        <a>Sắp xếp theo:</a>
